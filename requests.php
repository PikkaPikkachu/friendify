	...
	if(mysqli_num_rows($query) == 0)
		...
		while($row = mysqli_fetch_array($query)) {
			...
			if(isset($_POST['accept_request' . $user_from ])) {
				...
				$add_friend_query = mysqli_query($con, "INSERT INTO friends VALUES('', '$user_from', '$userLoggedIn')");
				$add_friend_query = mysqli_query($con, "INSERT INTO friends VALUES('', '$userLoggedIn', '$user_from')");
