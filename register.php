...
<body>
	...
	<div id="second">
		<form action="register.php" method="POST">
			...
			<input type="date" name="reg_dob" placeholder= "Date of Birth" value = "<?php
			...
			<?php if(in_array("<span style = 'color: #14C800'> You're all set! Go ahead and login!</span><br>", $error_array)){
			 	...
			 	}else if(in_array("<span style = 'color: #14C800'> User must be at least 18 years old!</span><br>", $error_array)){
					 echo "<span style = 'color: #14C800'> User must be at least 18 years old!</span><br>";
				}?>
