...
class Message {
	...
	public function sendMessage($user_to, $body, $date){
		...
		$check_body = preg_replace('/\s+/', '', $body); //Deletes all spaces 
	...
	public function getConvosDropDown($data, $limit){
		...
		if($count > $limit){
			...
			$return_string .= "<input type = 'hidden' class = 'noMoreDropDownDate' value = 'true'><p style= 'text-align: center;'> No more messages to load. </p>";
		}
